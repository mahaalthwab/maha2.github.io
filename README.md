...
.custom-cursor {
  ...
  pointer-events: none;
  z-index: 1000;
  mix-blend-mode: difference; /* دمج المؤشر مع الخلفية */
...
<br>
  ...
  <div class="gallery-item">
    <a href="https://www.behance.net/gallery/209212789/JetUp-case-study-UIUX/modules/1188529973" target="_blank">
      <img src="pic5.png" alt="Project 5">
...
<script>
  ...
  let mouseX = 0, mouseY = 0; // موقع الماوس
  let cursorX = 0, cursorY = 0; // موقع المؤشر
  ...
  // حركة سلسة للمؤشر مع تأثير فيزيائي
  function animateCursor() {
    cursorX += (mouseX - cursorX) * 0.1; // تحريك المؤشر بنسبة تدريجية
  ...
  // تغيير المؤشر عند التفاعل مع الصور
  galleryItems.forEach(item => {
    item.addEventListener('mouseenter', () => {
      cursor.style.transform = 'scale(3)';
      cursor.style.backgroundColor = 'rgba(255, 100, 100, 0.6)';
